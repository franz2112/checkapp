...
<html lang="en">
  <head>
    ...
    @vite([ 'public/assets/admin/css/soft-ui-dashboard.css?v=1.0.6"',
    'public/assets/admin/js/soft-ui-dashboard.js', 'public/assets/vendor/all.js'
    ]) @livewireStyles
  </head>
                ...
                <div class="row">
                  <div class="col-6">
                    <a
                      ...
                      href="{{ url('Appointment-Cancel', $AppointsInfo->id) }}"
                  ...
                  <div class="col-6">
                    ...
                    href="{{ url('Appointment-Approval', $AppointsInfo->id) }}"
