    ...
    >
      ...
      <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          {{-- dashbopard --}}
          <li class="nav-item">
            <a id="active"class="nav-link active" href="../pages/dashboard.html">
              <div
          ...
          {{-- set appoint --}}
          <li class="nav-item">
            <a class="nav-link" href="/Appointment-Set">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
              ...
              <span class="nav-link-text ms-1">Set Schedules</span>
            </a>
          </li>
          {{-- add doctor --}}
          <li class="nav-item">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div>
                              <img
                                src="../assets/admin/img/small-logos/logo-atlassian.svg"
                                class="avatar avatar-sm me-3"
                                alt="atlassian"
                              />
                            </div>
