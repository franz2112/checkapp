                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <img
                                          align="center"
                                          border="0"
                                          src="../assets/img/logo-section.png"
                                          alt="Logo"
                                          title="Logo"
                                          style="
                                            outline: none;
                            ...
                            <tr>
                              ...
                              >
                                <h3
                                  ...
                                  "
                                >
                                Hi<strong> {{$mailData['fname']}},</strong>
                                </h3>
                              </td>
                            </tr>
                          </tbody>
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 140%">
                                    <span
                                      ...
                                      "
                                    >
                                      Your ONLINE consultation appointment
                                      request with Dr. {{$mailData['Dfname']}}
                                      {{$mailData['Dlname']}}, has been
                                      APPROVED.
                                    </span>
                                  </p>
                                  <p style="font-size: 14px; line-height: 140%">
                                ...
                                >
                                  ...
                                  <p style="font-size: 14px; line-height: 140%">
                                    <span
                                      ...
                                      "
                                      >Consultation Link:
                                        <a type="button" href="{{$mailData['meetingLink']}}" class="btn btn-outline-primary">Meeting Link</a>
                                    </span
                                    >
                                  </p>
                                </div>
                                  ...
                                  <p style="font-size: 14px; line-height: 140%">
                                    <span
                                      style="
                                        ...
                                        font-family: Lato, sans-serif;
                                      "
                                      >Please prepare and login 20 minutes before your Time Schedule.
                                    </span>
                                  </p>
                                </div>
                              </td>
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 140%">
                                    <span
                                      ...
                                      us in CheckApp or contact us with our
                                      Email<a
                                        href="https://unlayer.com"
                                        target="_blank"
                                        rel="noopener"
                                      >
                                        <strong style="color: #18a843"
                                          >{{$mailData['cemail']}}</strong
                                        >&nbsp;</a
                                      >
                                  ...
                                  <p style="font-size: 14px; line-height: 140%">
                                    <span
                                      style="
                                        ...
                                        font-family: Lato, sans-serif;
                                      "
                                      >Thank you and see you there,</span
                                    >
                                  </p>
                                </div>
                              </td>
                                      ...
                                      ><strong
                                        ><span
                                          style="
                                            ...
                                            font-size: 16px;
                                          "
                                          >Click Link Below to confirm your
                                          appointment</span
                                        ></strong
                                      ></span
                                    >
                          ...
                          <tbody>
                            <tr>
                              ...
                              >
                                ...
                                [endif]-->
                                <div align="center">
                                  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com" style="height:39px; v-text-anchor:middle; width:190px;" arcsize="10.5%"  stroke="f" fillcolor="#7db00e"><w:anchorlock/><center style="color:#FFFFFF;font-family:arial,helvetica,sans-serif;"><![endif]-->
                                  <a
                                    href="https://unlayer.com"
                                    target="_blank"
                                    class="v-button"
                              ...
                              >
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 140%">
                                    ...
                                    us at support@CheckApp.com. All right
                                    reserved. Update email preferences or
                                    unsubscribe.<br />123-456-7890<br />Koronadal
                                    City. Philippines<br />Terms of use |
                                    Privacy Policy
                                  </p>
                                </div>
                              </td>
                          ...
                          <tbody>
                            <tr>
                              ...
                              >
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 140%">
                                    &copy; 2022 CheckApp. All Rights Reserved.
                                  </p>
                                </div>
                              </td>
                            </tr>
