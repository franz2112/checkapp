          ...
          >
            ...
            <ul class="navbar-nav justify-content-end">
              ...
              <li class="nav-item dropdown px-3 d-flex align-items-center">
                ...
                <ul
                  class="dropdown-menu dropdown-menu-end px-3 py-3 me-sm-n3"
                  aria-labelledby="dropdownMenuButton" 
                >
                <li class="mb-2 text-center">Settings</li>
                <li class="mb-2 text-center" style="font-size: 10px">Publish your Clinic</li>
